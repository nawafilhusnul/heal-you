...
<body>
    ...
    <div class="flex flex-col items-center px-6 py-10 min-h-dvh">
        ...
        <form method="POST" action="{{ route('login') }}"
            class="mx-auto max-w-[345px] w-full p-6 bg-white rounded-3xl
            mt-auto" id="deliveryForm">
            @csrf
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="password" name="password" id="password__"
                        class="form-input bg-[url('{{ asset('assets/svgs/ic-lock.svg') }}')]"
